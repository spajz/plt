...
return array(
    ...
    */
    ...
    |
    */
    'default_format'                        => '<div class="alert alert-:type alert-dismissable">:message<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>',
