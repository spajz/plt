    ...
    */
    ...
    'collections' => array(
        ...
        'login' => function ($collection) {
            ...
            $collection->add('packages/spajz/admin/assets/css/bootstrap.min.css');
            $collection->add('packages/spajz/admin/assets/css/font-awesome.min.css');
            $collection->add('packages/spajz/admin/assets/css/ace.min.css');

            $collection->add('packages/spajz/admin/assets/js/bootstrap.min.js');

            $collection->apply('CssMin');
            $collection->apply('UriRewriteFilter');
            $collection->apply('JsMin');

            $collection->rawOnEnvironment('local');
        },

        'admin_header' => function ($collection) {

            $collection->add('packages/spajz/admin/assets/css/bootstrap.min.css');
            $collection->add('packages/spajz/admin/assets/css/font-awesome.min.css');

            $collection->add('packages/spajz/admin/assets/css/ace.min.css');
            $collection->add('packages/spajz/admin/assets/css/ace-skins.min.css');

            // Dynatree
            $collection->add('packages/spajz/admin/assets/js/dynatree/skin-vista/ui.dynatree.css');

            $collection->add('packages/spajz/admin/assets/css/added.css');
        ...
        'admin_footer' => function ($collection) {

            $collection->add('packages/spajz/admin/assets/js/bootstrap.min.js');
            $collection->add('packages/spajz/admin/assets/js/typeahead-bs2.min.js');

            $collection->add('packages/spajz/admin/assets/js/jquery-ui-1.10.3.full.min.js');

            $collection->add('packages/spajz/admin/assets/js/ace-extra.min.js');

            $collection->add('packages/spajz/admin/assets/js/jquery.dataTables.min.js');
            $collection->add('packages/spajz/admin/assets/js/jquery.dataTables.bootstrap.js');

            $collection->add('packages/spajz/admin/assets/js/ace-elements.min.js');
            $collection->add('packages/spajz/admin/assets/js/ace.min.js');

            $collection->add('packages/spajz/admin/assets/ckeditor/ckeditor.js');
            $collection->add('packages/spajz/admin/assets/ckeditor/adapters/jquery.js');

            // Dynatree
            $collection->add('packages/spajz/admin/assets/js/jquery.cookie.js');
            $collection->add('packages/spajz/admin/assets/js/dynatree/jquery.dynatree.min.js');

            //$collection->add('packages/spajz/admin/assets/js/added.js');
        ...
        'admin_ie7' => function ($collection) {

            $collection->add('packages/spajz/admin/assets/css/font-awesome-ie7.min.css');
        ...
        'admin_ie8' => function ($collection) {

            $collection->add('packages/spajz/admin/assets/css/ace-ie.min.css');
        ...
        'admin_ie9' => function ($collection) {

            $collection->add('packages/spajz/admin/assets/js/html5shiv.js');
            $collection->add('packages/spajz/admin/assets/js/respond.min.js');
        ...
        'frontend_header' => function ($collection) {


            $collection->add('packages/spajz/frontend/css/bootstrap.min.css');
            $collection->add('packages/spajz/frontend/css/animate.min.css');
            $collection->add('packages/spajz/frontend/css/ddlevelsmenu-base.css');
            $collection->add('packages/spajz/frontend/css/ddlevelsmenu-topbar.css');
            $collection->add('packages/spajz/frontend/css/jquery.countdown.css');
            $collection->add('packages/spajz/frontend/css/font-awesome.min.css');
            $collection->add('packages/spajz/frontend/css/multi-columns-row.css');
            $collection->add('packages/spajz/frontend/css/style.css');
        ...
        'frontend_footer' => function ($collection) {
