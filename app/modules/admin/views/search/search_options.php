...
?>
<?php echo Form::open(array('route' => array('admin.api.searchOptions'), 'method' => 'post', 'class' => 'form-inline form-options ajax-form', 'role' => 'form', 'data-box' => '.form-search-box')); ?>
<?php echo Form::hidden('id', $item->{$item->getProperty()}); ?>
<?php echo Form::hidden('model', get_class($item)); ?>
    <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="form-group pull-right">
                <a class="btn btn-xs btn-success search-start" href="<?php echo URL::route('admin.api.search', array('page' => 1)); ?>">
