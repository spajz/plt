...
<?php echo Form::model($group, array('route' => array($base . 'update', $group->id), 'method' => 'put', 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'main-form', 'enctype' => 'multipart/form-data')); ?>
    ...
    <div class="widget-body">
        <div class="widget-main">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11">
                    <?php echo Form::text('id', $group->id, $attributes_field + array('disabled', 'id' => 'id')); ?>
                </div>
            </div>
    ...
    <div class="widget-body">
        <div class="widget-main">
            ...
            <table class="table table-striped table-bordered table-hover table-sortable">
                ...
                <tbody <?php echo create_dynamic_attributes('dynamic', $group, $group->id, 'admin::image.images'); ?>></tbody>
            </table>
    ...
    <div class="widget-body">
        <div class="widget-main">
            ...
            <table class="table table-striped table-bordered table-hover table-sortable">
                ...
                <tbody <?php echo create_dynamic_attributes('dynamic', $group, $group->id, 'admin::video.videos'); ?>></tbody>
...
<div class="form-search-box">
    <?php echo View::make('admin::search.search_options', array('item' => $group)); ?>
</div>
